...
int main(int arg, char ** argv)
{
	...
	//To compute interval for a solution
	...
	sol.SetUnbiasedExact( UnbiasedEstimator );

	//Trips Lb	
	std::vector<double> lbs = r.CalculateLb(targets);
	...
	printf("Avg trips per station per scenario:%.1lf\n",
		r.CalculateAverageTripsPerStationScenario());
